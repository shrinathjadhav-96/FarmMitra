import { DeviceRegistration } from '../utils';
 ...
 * @internal
 */
export declare const buildDeviceRegistration: (token?: string) => Promise<DeviceRegistration>;
/**
 ...
 */
export declare const registerDevice: RegisterDevice;
