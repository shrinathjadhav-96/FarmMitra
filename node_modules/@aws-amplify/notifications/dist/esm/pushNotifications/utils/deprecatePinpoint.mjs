...
const DEPRECATION_MESSAGE = 'The default `aws-amplify/push-notifications` entry point is deprecated because it is ' +
...
export { deprecatePinpoint };
//# sourceMappingURL=deprecatePinpoint.mjs.map
