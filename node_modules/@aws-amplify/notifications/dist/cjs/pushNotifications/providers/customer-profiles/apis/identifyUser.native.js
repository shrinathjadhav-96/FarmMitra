...
const identifyUserInternal_1 = require("../utils/identifyUserInternal");
/**
 ...
 */
const identifyUser = async ({ userProfile }) => {
    await (0, identifyUserInternal_1.identifyUserInternal)({ userProfile });
};
