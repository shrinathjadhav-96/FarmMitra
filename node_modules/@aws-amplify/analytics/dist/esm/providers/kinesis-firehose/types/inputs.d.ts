...
import { EventTrackingOptions, PageViewTrackingOptions, SessionTrackingOptions } from '../../../types/trackers';
 ...
 */
export interface KinesisFirehoseSessionTrackingOptions extends SessionTrackingOptions {
    streamName: string;
}
/**
 ...
 */
export interface KinesisFirehosePageViewTrackingOptions extends PageViewTrackingOptions {
    streamName: string;
}
/**
 ...
 */
export interface KinesisFirehoseEventTrackingOptions extends EventTrackingOptions {
    streamName: string;
}
/**
