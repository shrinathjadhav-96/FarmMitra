...
declare const PutRecordCommand_base: {
    new (input: PutRecordCommandInput): import("@smithy/core/client").CommandImpl<PutRecordCommandInput, PutRecordCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRecordCommandInput): import("@smithy/core/client").CommandImpl<PutRecordCommandInput, PutRecordCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
