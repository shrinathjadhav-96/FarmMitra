...
declare const GetShardIteratorCommand_base: {
    new (input: GetShardIteratorCommandInput): import("@smithy/core/client").CommandImpl<GetShardIteratorCommandInput, GetShardIteratorCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetShardIteratorCommandInput): import("@smithy/core/client").CommandImpl<GetShardIteratorCommandInput, GetShardIteratorCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
