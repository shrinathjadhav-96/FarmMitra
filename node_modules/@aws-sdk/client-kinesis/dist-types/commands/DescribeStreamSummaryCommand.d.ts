...
declare const DescribeStreamSummaryCommand_base: {
    new (input: DescribeStreamSummaryCommandInput): import("@smithy/core/client").CommandImpl<DescribeStreamSummaryCommandInput, DescribeStreamSummaryCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeStreamSummaryCommandInput]): import("@smithy/core/client").CommandImpl<DescribeStreamSummaryCommandInput, DescribeStreamSummaryCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
