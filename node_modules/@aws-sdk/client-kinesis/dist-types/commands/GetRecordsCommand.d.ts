...
declare const GetRecordsCommand_base: {
    new (input: GetRecordsCommandInput): import("@smithy/core/client").CommandImpl<GetRecordsCommandInput, GetRecordsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRecordsCommandInput): import("@smithy/core/client").CommandImpl<GetRecordsCommandInput, GetRecordsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
