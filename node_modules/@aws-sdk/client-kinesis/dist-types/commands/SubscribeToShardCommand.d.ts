...
declare const SubscribeToShardCommand_base: {
    new (input: SubscribeToShardCommandInput): import("@smithy/core/client").CommandImpl<SubscribeToShardCommandInput, SubscribeToShardCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SubscribeToShardCommandInput): import("@smithy/core/client").CommandImpl<SubscribeToShardCommandInput, SubscribeToShardCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
