...
declare const UpdateStreamWarmThroughputCommand_base: {
    new (input: UpdateStreamWarmThroughputCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamWarmThroughputCommandInput, UpdateStreamWarmThroughputCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStreamWarmThroughputCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamWarmThroughputCommandInput, UpdateStreamWarmThroughputCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
