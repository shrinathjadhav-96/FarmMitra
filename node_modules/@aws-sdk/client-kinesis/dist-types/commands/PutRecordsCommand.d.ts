...
declare const PutRecordsCommand_base: {
    new (input: PutRecordsCommandInput): import("@smithy/core/client").CommandImpl<PutRecordsCommandInput, PutRecordsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRecordsCommandInput): import("@smithy/core/client").CommandImpl<PutRecordsCommandInput, PutRecordsCommandOutput, import("..").KinesisClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
