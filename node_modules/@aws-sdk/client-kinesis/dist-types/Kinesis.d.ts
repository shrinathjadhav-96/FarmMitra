...
export interface Kinesis {
     ...
     */
    waitUntilChannelActive(args: DescribeChannelCommandInput, waiterConfig: number | Omit<WaiterConfiguration<Kinesis>, "client">): Promise<WaiterResult<DescribeChannelCommandOutput>>;
    /**
     * @see {@link DescribeStreamCommand}
     * @param args - command input.
     * @param waiterConfig - `maxWaitTime` in seconds or waiter config object.
